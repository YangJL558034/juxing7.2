  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-6 gap-4">
        <div className="flex flex-wrap items-center gap-2 md:gap-4">
          <Select defaultValue="all">
            ...
            <SelectContent>
              <SelectItem value="all">全部线索</SelectItem>
            ...
            <DialogContent className="max-w-md">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    <Label htmlFor="industry">客户行业</Label>
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select value={formData.level} onValueChange={(v) => setFormData({ ...formData, level: v })}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="无效客户">无效客户</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={handleCreateLead} disabled={!formData.name}>确定</Button>
              </div>
            </DialogContent>
          </Dialog>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between mt-4 gap-2">
        <span className="text-sm text-slate-600">共 {filteredLeads.length} 条数据</span>
